      ...
      <div className="flex flex-col gap-3">
            ...
            <div className="mt-2">
                ...
                <div className="flex flex-col gap3">
                   ...
                   {properties.map((property, index) => (
                    ...
                    <div className="flex items-center gap-3 mt-2">
                        <input type="text" className="border putline-none border-gray-700 bg-gray-800 p-2 rounded-md text-white w-full" 
                ...
                <div className="flex items-center gap-2 mt-1">
                    <Input 
                    placeholder='Enter property label (e.g, Material, Kilos, Weights'
                    value={newLabel}
