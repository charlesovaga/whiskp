...
import DeleteDiscountModal from 'apps/vendor-ui/src/shared/components/modals/delete_discount_code'
                                        ...
                                        <form onSubmit={handleSubmit(onSubmit)} className="mt-4">
                                            ...
                                            <div className="mt-2">
                                                ...
                                                render={({ field }) => (
                                                    <select
                                                    {...field}
                                                    className='w-full border outline-none border-gray-700 bg-transparent bg-gray-700 p-3 rounded-md text-white'
                                                    >
