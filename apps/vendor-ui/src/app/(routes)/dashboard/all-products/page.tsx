...
import DeletConfirmationModal from 'apps/vendor-ui/src/shared/components/modals/delete.confirmation.modal'
...
function ProductList() {
            ...
            },
            {
                ...
                cell: ({row}:any) => (
                    <div className="flex gap-3">
                        ...
                        onClick={() => openDeleteModals(row.original)}
                        >
                            <Trash size={18}/>
    ...
    const openDeleteModals = (product:any) =>{
  ...
  return (
    <div className='w-full min-h-screen p-8'>
        ...
        <div className="flex justify-between items-center mb-1">
            ...
            className='bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex justify-center'
            >
