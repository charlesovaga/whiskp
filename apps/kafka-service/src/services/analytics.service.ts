...
export const updateUserAnalytics = async(event:any) => {
    try {
        ...
        // Always store `Product_view` for recommedations
        ...
        // Remove "add_to_cart" when "remove_to_cart" is triggered
        ...
        // Remove "add_to_whislist" when "remove_to_whishlist" is triggered
        ...
        console.log("Error storing user analytic:", error)
    }
}
...
export const updateProductAnalytics = async(event:any) => {
    try {
        ...
        if (event.action === "remove_from_cart") updateFields.views = {decrement: 1}
        ...
        console.log("Error storing product analytic:", error)
    }
}